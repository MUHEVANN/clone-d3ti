...
const Congrate = () => {
  return (
    <div className="w-full h-[90vh] justify-center md:h-[80vh] bg-gradient flex flex-col md:flex-row layout items-center">
      ...
      <div className="border-[#f59e0b] p-2 border-2  rounded-lg ">
        <img src={congrate} alt="" className=" w-[700px] rounded-lg" />
      </div>
    </div>
  );
};
